...
import useRegister from "../../components/hooks/organization/useRegister";

function Register() {
  const { formData, loading, success, error, handleInputChange, handleSubmit } =
    useRegister();
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-10">
              <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                Create an organization account with Verselet
              </h1>
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="This is test organization."
                    required={true}
                  />
                </div>
                <div>
