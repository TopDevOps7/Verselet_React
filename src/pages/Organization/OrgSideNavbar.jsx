...
function OrgSideNavbar() {
  ...
  return window.location.pathname.split("/")[1] == "organization" && (window.location.pathname.split("/")[2] == "" || protectedPages.includes(window.location.pathname.split("/")[2])) ? 
    (<div>
