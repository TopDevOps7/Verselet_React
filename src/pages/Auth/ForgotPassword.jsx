...
import useForgotPassword from "../../components/hooks/user/useForgotPassword";

function ForgotPassword() {
  const { email, setEmail, handleSubmit, success, error } = useForgotPassword();
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-10">
              <h1 className="text-lg font-bold leading-tight tracking-tight text-gray-900 md:text-3xl dark:text-white">
