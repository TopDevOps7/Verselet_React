            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center ml-3">
                ...
                >
                  ...
                  <ul className="rounded-lg" role="none">
                    <li>
                      <Link
                        to="/settings"
                    ...
                    <li>
                      <Link
                        to="/logout"
                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-red-500 dark:hover:text-white"
                        role="menuitem"
                      >
                        Sign out
                      </Link>
